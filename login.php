...
<body>
    ...
    <div class="login-card">
        ...
        <div class="telegram-login-YourBotName"></div> <!-- Telegram Widget Container -->
    </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            const telegramWidget = document.querySelector('.telegram-login-YourBotName');
