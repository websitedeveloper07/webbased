...
try {
    ...
    error_log("Database PDO Error in shopify1$.php: " . $e->getMessage());
    echo json_encode(['status' => 'ERROR', 'message' => 'Database connection error']);
    exit;
} catch (Exception $e) {
    error_log("General Error in shopify1$.php: " . $e->getMessage());
...
function sendTelegramNotification($card_details, $status, $response, $originalApiResponse = null) {
    ...
    try {
        ...
        $gateway = 'Shopify 1$'; // Updated for this gateway
